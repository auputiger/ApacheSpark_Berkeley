...
# TODO: Replace <FILL IN> with appropriate code
pluralRDD = wordsRDD.map(makePlural) #(<FILL IN>)
...
# TODO: Replace <FILL IN> with appropriate code
pluralLambdaRDD = wordsRDD.map(lambda word : word + 's') #<FILL IN>)
...
# TODO: Replace <FILL IN> with appropriate code
wordPairs = wordsRDD.map(lambda word : (word, 1)) #<FILL IN>
...
wordsGrouped = wordPairs.groupByKey() #<FILL IN>
...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.mapValues(lambda x: sum(list(x))) #<FILL IN>
...
wordCounts = wordPairs.reduceByKey(lambda a, b: a+b) #<FILL IN>)
...
# TODO: Replace <FILL IN> with appropriate code
#uniqueWords = len(wordsRDD.distinct().collect()) #<FILL IN>
...
totalCount = (wordCounts
              .map(lambda (key, value): value)#<FILL IN>)
              .reduce(add))#))
average = totalCount / float(uniqueWords) #<FILL IN>)
print totalCount
...
# TODO: Replace <FILL IN> with appropriate code
shakespeareWordsRDD = shakespeareRDD.flatMap(lambda x: re.split(' ', x)) #<FILL_IN>
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordsRDD = shakespeareWordsRDD.filter(lambda x: x !='') #<FILL_IN>
...
# TODO: Replace <FILL IN> with appropriate code
top15WordsAndCounts = wordCount(shakeWordsRDD).takeOrdered(15,key=lambda x: -x[1]) #<FILL IN>
